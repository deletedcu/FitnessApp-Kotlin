...
class Metric {
    companion object {
        ...
        const val SECONDARY_METRIC_SPEED = 23
        const val SECONDARY_METRIC_RATE = 24
        const val SECONDARY_METRIC_PACE = 25
        const val SECONDARY_METRIC_POWER = 26
        const val SECONDARY_METRIC_HIGH = 26
