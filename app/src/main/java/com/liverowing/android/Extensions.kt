...
fun Float.roundDown(multiple: Float): Float {
    return if (this >= 0) this / multiple * multiple else (this - multiple + 1) / multiple * multiple
}

/** round n up to nearest multiple of m  */
fun Float.roundUp(multiple: Float): Float {
