...
import com.liverowing.android.csafe.Frame
...
import com.liverowing.android.service.operations.GattOperation
import com.liverowing.android.service.operations.GattReadCharacteristicOperation
import com.liverowing.android.service.operations.GattSetNotificationOperation
import com.liverowing.android.service.operations.GattWriteCharacteristicOperation
...
class BleDevice(val context: Context, val device: BluetoothDevice) : Device() {
    ...
    private val informationServiceUUID = UUID.fromString(PM_DEVICEINFO_SERVICE_UUID_STRING)
    ...
    private inner class GattClientCallback(device: BluetoothDevice) : BluetoothGattCallback() {
        ...
        override fun onServicesDiscovered(gatt: BluetoothGatt, status: Int) {
            ...
            // TODO: Some day we might want to fetch information about FW, etc.
            /*
            val informationService = gatt.getService(informationServiceUUID)
            informationService.characteristics
                    .forEach { addOperation(GattReadCharacteristicOperation(device, informationServiceUUID, it.uuid, {})) }
            */
        ...
        override fun onCharacteristicRead(gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic, status: Int) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                val string = String(characteristic.value)
                Log.d("LiveRowing", "Characteristic read successfully, value: $string")
            } else {
