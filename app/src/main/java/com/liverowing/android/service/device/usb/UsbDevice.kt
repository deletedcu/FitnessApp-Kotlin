package com.liverowing.android.service.device.usb
...
import com.liverowing.android.service.device.usb.c2.VPM
...
class UsbDevice(val context: Context, val device: UsbDevice) : Device() {
    ...
    override fun setupWorkout(workoutType: com.liverowing.android.model.parse.WorkoutType, targetPace: Int?) {
