 ...
 * @since 3.1.1
 */
public abstract class MvpLceBottomSheetDialogFragment<CV extends View, M, V extends MvpLceView<M>, P extends MvpPresenter<V>>
        extends MvpBottomSheetDialogFragment<V, P> implements MvpLceView<M> {
